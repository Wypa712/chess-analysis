...
- Імпортувати тільки вибраний режим: 25 / 50 / 100 найновіших партій або партії за останні 7 / 30 / 90 днів.
...
- Основна модель: `gemini-2.0-flash`.
- Fallback-модель: `llama-3.3-70b-versatile`.
