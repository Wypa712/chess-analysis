...
**Завершено:** Фази 1–6.1, Фаза 7A, Фаза 7.0, Фаза 7B  
**Поточна фаза:** Фаза 7C — Рефакторинг GameView (1-2 дні)  
**Наступна фаза:** Фаза 8 — Тести критичної логіки (1 день)  
...
### Фаза 7C — Рефакторинг GameView (1-2 дні) ⚠️ КРИТИЧНО

- [ ] **[7C-1]** `EvalSection` — eval bar, chart, accuracy, phase accuracy
- [ ] **[7C-2]** `ExplorePanel` — breadcrumb, drag-to-scroll
- [ ] **[7C-3]** `LlmTabsPanel` — таб-система з LlmAnalysis
- [ ] **[7C-4]** Спростити `GameView.tsx` — 1432 → ~400-500 рядків
