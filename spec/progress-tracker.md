...
**Остання зміна:** 2026-05-12 — прибрано explore breadcrumb bar з game view
...
- Розмір дошки на game view тепер рахується синхронно до paint, від реальної ширини board area, і округлюється до кратного 8px, щоб при переході дошка не стрибала і клітинки не рендерились нерівномірно.
- Explore breadcrumb bar прибрано з game view повністю: explore mode лишається через drag на дошці, quick Stockfish-кандидати, підсвічування останнього ходу варіанту і кнопку повернення до основної лінії, без layout shifts над або під дошкою.
