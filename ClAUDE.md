...
Реалізація кожної фази включає мінімум 2 етапи. Перший етап - створення дизайну та верстки згідно вимог дизайну, прикладів в прототипах, необхідного функціоналу фази. Другий етап - реалізація функціоналу фази під створену верстку.
